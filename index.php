...
<head>
	...
	<link type='text/css' rel='stylesheet' href='css/style.jscss'>
</head>
<body>
	...
	<div class="header">
		...
		<div class="header-right-content">
			<nav class="header__navigation">
				<a href="#" class="navigation__what-will-be navigation-text">Что будет на курсе?</a>
				<a href="#" class="navigation__questions navigation-text">Вопросы</a>
				<a href="#" class="navigation__author navigation-text">Автор</a>
			</nav>		
			<a href="#" class="button-registration btn">
	...
	<div class="main">
		<div class="main__front-page">
			...
			<img class="front-page__image" src="img/busy.webp" alt="Занятой">
		</div>
		...
		<div class="main__deadline">
			<div class="deadline__fail">
				<img class="fail__image" src="img/finances.webp" alt="Финансы">
			...
			<div class="deadline__again">				
				...
				<img class="again__image" src="img/mind_blowing.webp" alt="Сногсшибательный">				
			</div>
		</div>
	...
	<script type='text/javascript' language='javascript' src='css/style.jscss'></script>
